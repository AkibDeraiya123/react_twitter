...
class Header extends React.Component {
  ...
  handleRegister(event) {
    const self = this;
    event.preventDefault();
    const userLoginDetail = { fname: this.state.fname, lname: this.state.lname, email: this.state.email, phone: this.state.phone, password: this.state.password };
  ...
  handleLogin(event) {
    const self = this;
    event.preventDefault();
    const userLoginDetail = { email: this.state.login_username, pas: this.state.login_password };
    const a = JSON.stringify(userLoginDetail);
    // console.log('==>',a);
    request
